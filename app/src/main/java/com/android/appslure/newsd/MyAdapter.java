...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> implements View.OnClickListener {
    ...
    private static final int TYPE_ITEM_DropDOWN=2;
    ...
    MyAdapter(String Titles[],Context context) { // MyAdapter Constructor with titles and icons parameter
